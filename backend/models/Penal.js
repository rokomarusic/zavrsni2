...
module.exports = class Penal{
    ...
    static async dohvatiPenaleKluba(idklub, idtim, godinasezona){
        const sql = `select * from penal natural join dogadaj natural join
    ...
    static async dohvatiPenaleDrzave(iddrzava, idtim, godinasezona){
        const sql = `select * from penal natural join dogadaj natural join utakmica natural join natjecanje join igrac
