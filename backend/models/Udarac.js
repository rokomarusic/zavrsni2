...
module.exports = class Udarac{
    ...
    static async dohvatiUdarceKluba(idklub, idtim, godinasezona){
        const sql = `select * from udarac natural join dogadaj natural join
    ...
    static async dohvatiUdarceDrzave(iddrzava, idtim, godinasezona){
        const sql = `select * from udarac natural join dogadaj natural join utakmica natural join natjecanje join igrac
